...
interface ServiceabilityApiList {
    ...
    suspend fun sampleFileServiceability(@Path("company_id") companyId: String,@Body body: BulkRegionServiceabilityTatRequest, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun getSampleFileServiceabilityStatus(@Path("company_id") companyId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?, @Query("batch_id") batchId: String?, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun validateBulkGeoarea(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: ZoneBulkValidationRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun getBulkGeoareaValidation(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("batch_id") batchId: String, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun importBulkGeoarea(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("batch_id") batchId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<ZoneBulkValidationStatusResponse>
    
    @GET ("/service/platform/logistics/v1.0/company/{company_id}/application/{application_id}/geoareas/bulk/import/{batch_id}")
    suspend fun importBulkGeoareaStatus(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("batch_id") batchId: String, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun overrideBulkGeoarea(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("batch_id") batchId: String,@Body body: BulkZoneOverrideSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun getGeoareaOverrideStatus(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("batch_id") batchId: String, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun createCourierPartnerScheme(@Path("company_id") companyId: String,@Body body: CourierPartnerSchemeModel, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun updateCourierPartnerScheme(@Path("company_id") companyId: String, @Path("scheme_id") schemeId: String,@Body body: CourierPartnerSchemeUpdateRequest, @HeaderMap headers: Map<String, String>? = null)
