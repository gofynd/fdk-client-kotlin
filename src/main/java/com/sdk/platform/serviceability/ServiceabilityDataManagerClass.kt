...
class ServiceabilityDataManagerClass(val config: PlatformConfig, val unauthorizedAction: ((url: String, responseCode: Int) -> Unit)? = null) : BaseRepository() {
    ...
    suspend fun sampleFileServiceability(body: BulkRegionServiceabilityTatRequest, headers: Map<String, String> = emptyMap())
    : Response<BulkRegionServiceabilityTatResponseItemData>? {
    ...
    : Response<BulkRegionServiceabilityTatResponse>? {
        ...
        companyId = config.companyId,pageNo = pageNo,pageSize = pageSize,batchId = batchId, headers = headers)
        } else {
            null
        }
    }
    ...
    suspend fun createCourierPartnerScheme(body: CourierPartnerSchemeModel, headers: Map<String, String> = emptyMap())
    : Response<CourierPartnerSchemeModel>? {
    ...
    suspend fun updateCourierPartnerScheme(schemeId: String,body: CourierPartnerSchemeUpdateRequest, headers: Map<String, String> = emptyMap())
    : Response<CourierPartnerSchemeUpdateRequest>? {

        return if (config.oauthClient.isAccessTokenValid()) {
            serviceabilityApiList?.updateCourierPartnerScheme(
        companyId = config.companyId,schemeId = schemeId, body = body,headers = headers)
        } else {
            null
        }
    }
...
inner class ApplicationClient(val applicationId:String,val config: PlatformConfig){
    ...
    suspend fun validateBulkGeoarea(body: ZoneBulkValidationRequestSchema, headers: Map<String, String> = emptyMap())
    : Response<ZoneBulkValidationResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                serviceabilityApiList?.validateBulkGeoarea(companyId = config.companyId ,applicationId = applicationId , body = body,headers = headers)
        } else {
            null
        }
    }
    ...
    suspend fun getBulkGeoareaValidation(batchId: String, headers: Map<String, String> = emptyMap())
    : Response<ZoneBulkValidationStatusResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                serviceabilityApiList?.getBulkGeoareaValidation(companyId = config.companyId ,applicationId = applicationId ,batchId = batchId, headers = headers)
        } else {
            null
        }
    }
    ...
    suspend fun importBulkGeoarea(batchId: String, headers: Map<String, String> = emptyMap())
    : Response<ZoneBulkValidationStatusResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                serviceabilityApiList?.importBulkGeoarea(companyId = config.companyId ,applicationId = applicationId ,batchId = batchId, headers = headers)
        } else {
            null
        }
    }
    ...
    suspend fun importBulkGeoareaStatus(batchId: String, headers: Map<String, String> = emptyMap())
    : Response<ZoneBulkImportResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                serviceabilityApiList?.importBulkGeoareaStatus(companyId = config.companyId ,applicationId = applicationId ,batchId = batchId, headers = headers)
        } else {
            null
        }
    }
    ...
    suspend fun overrideBulkGeoarea(batchId: String,body: BulkZoneOverrideSchema, headers: Map<String, String> = emptyMap())
    : Response<BulkZoneOverrideResponseSchema>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                serviceabilityApiList?.overrideBulkGeoarea(companyId = config.companyId ,applicationId = applicationId ,batchId = batchId, body = body,headers = headers)
        } else {
            null
        }
    }
    ...
    suspend fun getGeoareaOverrideStatus(batchId: String, headers: Map<String, String> = emptyMap())
    : Response<ZoneOverrideStatusResponseSchema>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                serviceabilityApiList?.getGeoareaOverrideStatus(companyId = config.companyId ,applicationId = applicationId ,batchId = batchId, headers = headers)
        } else {
            null
        }
    }
