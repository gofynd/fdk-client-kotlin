...
data class ShipmentMeta(
    ...
    @SerializedName("credit_note_data")
    var creditNoteData: CreditNoteData?=null,
...
data class PDFLink(
    ...
    @SerializedName("credit_note_a4")
    var creditNoteA4: String?=null
