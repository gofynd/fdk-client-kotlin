...
interface OrderApiList {
    ...
    suspend fun getStateTransitionFlags(@Path("company_id") companyId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    : Response<HashMap<String,Any>>
    
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/state/transition/flags/{flag_id}")
    suspend fun getStateTransitionFlagsById(@Path("company_id") companyId: String, @Path("flag_id") flagId: String)
    : Response<HashMap<String,Any>>
    
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/state/transition/filters")
    suspend fun getStateTransitionFilters(@Path("company_id") companyId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    : Response<HashMap<String,Any>>
    
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/state/transition/filters/{filter_id}")
    suspend fun getStateTransitionFiltersById(@Path("company_id") companyId: String, @Path("filter_id") filterId: String)
    : Response<HashMap<String,Any>>
    
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/state/transition/tasks")
    suspend fun getStateManagerTasks(@Path("company_id") companyId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    : Response<HashMap<String,Any>>
    
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/state/transition/tasks/{task_id}")
    suspend fun getStateManagerTaskById(@Path("company_id") companyId: String, @Path("task_id") taskId: String)
    : Response<HashMap<String,Any>>
    
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/application/{application_id}/states")
    suspend fun getStateManagerStates(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    : Response<PaginatedStates>
