...
interface CommunicationApiList {
    ...
    suspend fun sendByCompanyCommunicationSynchronously(@Header("x-application-id") xApplicationId: String, @Path("company_id") companyId: String,@Body body: EngineRequest)
    ...
    suspend fun sendEngineCommunicationSynchronously(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: EngineRequest)
    : Response<SendInstantResponse>
    
    @POST ("/service/platform/communication/v1.0/company/{company_id}/engine/send-async")
    suspend fun senByCompanyCommunicationAsynchronously(@Header("x-application-id") xApplicationId: String, @Path("company_id") companyId: String,@Body body: EngineRequest)
    ...
    suspend fun sendByCompanyCommunicationInstantly(@Header("x-application-id") xApplicationId: String, @Path("company_id") companyId: String,@Body body: EngineRequest)
    : Response<SendInstantResponse>
    ...
    @POST ("/service/platform/communication/v1.0/company/{company_id}/application/{application_id}/log")
    suspend fun createCommunicationLogs(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: Log)
    : Response<Log>
    ...
    suspend fun updateAppProvidersGlobalProvider(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: AppProvidersGlobalProviderRequest)
    ...
    suspend fun deleteCampaignById(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String)
    : Response<BasicDelete>
    ...
    suspend fun updateOtpConfiguration(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: OtpConfiguration)
    : Response<OtpConfiguration>
    
    @POST ("/service/platform/communication/v1.0/company/{company_id}/application/{application_id}/pn/tokens")
    suspend fun createAppPushtoken(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: PushtokenReq)
