...
inner class ApplicationClient(val applicationId:String,val config: PlatformConfig){
    ...
    suspend fun getPromotionOffers(slug: String?=null, pageSize: Int?=null, promotionGroup: String?=null, storeId: Int?=null, cartType: String?=null)
    : Response<PromotionOffersResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                cartApiList?.getPromotionOffers(companyId = config.companyId , applicationId = applicationId , slug = slug, pageSize = pageSize, promotionGroup = promotionGroup, storeId = storeId, cartType = cartType )
        } else {
            null
        }
    }
    ...
    suspend fun getPromotionPaymentOffers(id: String?=null, uid: Int?=null)
    : Response<PromotionPaymentOffersResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                cartApiList?.getPromotionPaymentOffers(companyId = config.companyId , applicationId = applicationId , id = id, uid = uid )
        } else {
            null
        }
    }
    ...
    suspend fun getCart(id: String?=null, userId: String?=null, orderType: String?=null, i: Boolean?=null, b: Boolean?=null, assignCardId: Int?=null, buyNow: Boolean?=null)
    : Response<CartDetailResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                cartApiList?.getCart(companyId = config.companyId , applicationId = applicationId , id = id, userId = userId, orderType = orderType, i = i, b = b, assignCardId = assignCardId, buyNow = buyNow )
        } else {
            null
        }
    }
    ...
    suspend fun platformAddItems(i: Boolean?=null, b: Boolean?=null, buyNow: Boolean?=null, orderType: String?=null, id: String?=null,body: PlatformAddCartRequest)
    : Response<AddCartDetailResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                cartApiList?.platformAddItems(companyId = config.companyId , applicationId = applicationId , i = i, b = b, buyNow = buyNow, orderType = orderType, id = id, body = body)
        } else {
            null
        }
    }
    ...
    suspend fun platformUpdateCart(id: String?=null, i: Boolean?=null, orderType: String?=null, b: Boolean?=null, buyNow: Boolean?=null,body: PlatformUpdateCartRequest)
    : Response<UpdateCartDetailResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                cartApiList?.platformUpdateCart(companyId = config.companyId , applicationId = applicationId , id = id, i = i, orderType = orderType, b = b, buyNow = buyNow, body = body)
        } else {
            null
        }
    }
