...
interface CartApiList {
    ...
    suspend fun fetchAndvalidateCartItems(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: OpenapiCartDetailsRequestObject, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun checkCartServiceability(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: OpenApiCartServiceabilityRequestObject, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun addItems(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("cart_id") cartId: String, @Query("b") b: Boolean?,@Body body: AddCartRequestObject, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun updateCart(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("cart_id") cartId: String, @Query("b") b: Boolean?,@Body body: UpdateCartRequestObject, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun getCartShareLink(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: GetShareCartLinkRequestObject, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun platformAddItems(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("i") i: Boolean?, @Query("b") b: Boolean?, @Query("buy_now") buyNow: Boolean?, @Query("id") id: String?, @Query("cart_type") cartType: String?,@Body body: PlatformAddCartRequestObject, @HeaderMap headers: Map<String, String>? = null)
    : Response<AddCartDetailResponseObject>
    ...
    suspend fun platformUpdateCart(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("i") i: Boolean?, @Query("order_type") orderType: String?, @Query("b") b: Boolean?, @Query("buy_now") buyNow: Boolean?, @Query("cart_type") cartType: String?,@Body body: PlatformUpdateCartRequestObject, @HeaderMap headers: Map<String, String>? = null)
    : Response<UpdateCartDetailResponseObject>
    
    @PUT ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/cart_archive")
    suspend fun deleteCart(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("cart_type") cartType: String?,@Body body: DeleteCartRequestObject, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun applyCoupon(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("i") i: Boolean?, @Query("b") b: Boolean?, @Query("p") p: Boolean?, @Query("id") id: String?, @Query("buy_now") buyNow: Boolean?,@Body body: ApplyCouponRequestObject, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResponseObject>
    ...
    suspend fun selectAddress(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("cart_id") cartId: String?, @Query("buy_now") buyNow: Boolean?, @Query("i") i: Boolean?, @Query("b") b: Boolean?,@Body body: PlatformSelectCartAddressRequestObject, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResponseObject>
    ...
    suspend fun updateShipments(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("i") i: Boolean?, @Query("p") p: Boolean?, @Query("id") id: String?, @Query("address_id") addressId: String?, @Query("area_code") areaCode: String?, @Query("order_type") orderType: String?,@Body body: UpdateCartShipmentRequestObject, @HeaderMap headers: Map<String, String>? = null)
    : Response<PlatformCartShipmentsResponseObject>
    
    @PUT ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/meta")
    suspend fun updateCartMeta(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("buy_now") buyNow: Boolean?, @Query("user_id") userId: String?,@Body body: PlatformCartMetaRequestObject, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartMetaResponseObject>
    
    @POST ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/checkout")
    suspend fun platformCheckoutCart(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("cart_type") cartType: String?,@Body body: PlatformCartCheckoutDetailRequestObject, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun selectPaymentMode(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("buy_now") buyNow: Boolean?, @Query("order_type") orderType: String?,@Body body: UpdateCartPaymentRequestObject, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResponseObject>
    ...
    suspend fun platformCheckoutCartV2(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("cart_type") cartType: String?,@Body body: PlatformCartCheckoutDetailV2RequestObject, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartCheckoutResponseObject>
