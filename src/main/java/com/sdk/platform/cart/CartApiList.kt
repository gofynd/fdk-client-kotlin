...
interface CartApiList {
    ...
    suspend fun fetchAndvalidateCartItems(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-location-detail") xLocationDetail: String?, @Header("x-currency-code") xCurrencyCode: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: OpenapiCartDetailsCreation, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun overrideCart(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-location-detail") xLocationDetail: String?, @Header("x-currency-code") xCurrencyCode: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: OverrideCheckoutReq, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun getCart(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("user_id") userId: String?, @Query("order_type") orderType: String?, @Query("i") i: Boolean?, @Query("b") b: Boolean?, @Query("assign_card_id") assignCardId: Int?, @Query("buy_now") buyNow: Boolean?, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResult>
    
    @POST ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/detail")
    suspend fun platformAddItems(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("i") i: Boolean?, @Query("b") b: Boolean?, @Query("include_cart_calculation") includeCartCalculation: Boolean?, @Query("buy_now") buyNow: Boolean?, @Query("order_type") orderType: String?, @Query("id") id: String?,@Body body: PlatformAddCartDetails, @HeaderMap headers: Map<String, String>? = null)
    : Response<AddCartDetailResult>
    
    @PUT ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/detail")
    suspend fun platformUpdateCart(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("i") i: Boolean?, @Query("order_type") orderType: String?, @Query("b") b: Boolean?, @Query("include_cart_calculation") includeCartCalculation: Boolean?, @Query("buy_now") buyNow: Boolean?,@Body body: PlatformUpdateCartDetails, @HeaderMap headers: Map<String, String>? = null)
    : Response<UpdateCartDetailResult>
    
    @PATCH ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/detail")
    suspend fun updateCartBreakup(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("i") i: Boolean?, @Query("b") b: Boolean?, @Query("include_cart_calculation") includeCartCalculation: Boolean?, @Query("buy_now") buyNow: Boolean?,@Body body: UpdateCartBreakup, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResult>
    ...
    suspend fun applyCoupon(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("i") i: Boolean?, @Query("b") b: Boolean?, @Query("p") p: Boolean?, @Query("id") id: String?, @Query("buy_now") buyNow: Boolean?,@Body body: ApplyCouponDetails, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResult>
    
    @DELETE ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/platform-pos-coupon")
    suspend fun removeCoupon(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("uid") uid: String?, @Query("buy_now") buyNow: Boolean?, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResult>
    ...
    suspend fun selectAddress(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("cart_id") cartId: String?, @Query("buy_now") buyNow: Boolean?, @Query("i") i: Boolean?, @Query("b") b: Boolean?,@Body body: PlatformSelectCartAddress, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResult>
    ...
    suspend fun platformCheckoutCart(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?,@Body body: PlatformCartCheckoutDetailCreation, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun selectPaymentMode(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("buy_now") buyNow: Boolean?, @Query("order_type") orderType: String?,@Body body: CartPaymentUpdate, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResult>
    
    @GET ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/payment/validate/")
    suspend fun validateCouponForPayment(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("buy_now") buyNow: Boolean?, @Query("address_id") addressId: String?, @Query("payment_mode") paymentMode: String?, @Query("payment_identifier") paymentIdentifier: String?, @Query("aggregator_name") aggregatorName: String?, @Query("merchant_code") merchantCode: String?, @HeaderMap headers: Map<String, String>? = null)
    : Response<PaymentCouponValidate>
    
    @POST ("/service/platform/cart/v2.0/company/{company_id}/application/{application_id}/checkout")
    suspend fun platformCheckoutCartV2(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Header("x-anonymous-cart") xAnonymousCart: String?, @Header("x-location-detail") xLocationDetail: String?, @Header("x-currency-code") xCurrencyCode: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?,@Body body: PlatformCartCheckoutDetailV2Creation, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartCheckoutDetails>
    
    @PUT ("/service/platform/cart/v2.0/company/{company_id}/application/{application_id}/payment")
    suspend fun selectPaymentModeV2(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("buy_now") buyNow: Boolean?, @Query("order_type") orderType: String?,@Body body: UpdateCartPaymentRequestV2, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResult>
    
    @POST ("/service/platform/cart/v2.0/company/{company_id}/application/{application_id}/redeem")
    suspend fun applyLoyaltyPoints(@Header("x-ordering-source") xOrderingSource: String?, @Header("x-ordering-source-type") xOrderingSourceType: String?, @Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("id") id: String?, @Query("i") i: Boolean?, @Query("b") b: Boolean?, @Query("buy_now") buyNow: Boolean?,@Body body: RedeemLoyaltyPoints, @HeaderMap headers: Map<String, String>? = null)
    : Response<CartDetailResult>
    
    @GET ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/offers")
    suspend fun getOffers(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?, @Query("search") search: String?, @Query("mode") mode: String?, @Query("type") type: String?, @Query("promo_group") promoGroup: String?, @Query("exclude_contract_offers") excludeContractOffers: Boolean?, @Query("offer_id") offerId: String?, @Query("created_by") createdBy: String?, @Query("reviewed_by") reviewedBy: String?, @Query("approved_start_time") approvedStartTime: String?, @Query("approved_end_time") approvedEndTime: String?, @Query("status") status: String?, @Query("code") code: String?, @Query("is_public") isPublic: Boolean?, @Query("filter_tags") filterTags: String?, @HeaderMap headers: Map<String, String>? = null)
