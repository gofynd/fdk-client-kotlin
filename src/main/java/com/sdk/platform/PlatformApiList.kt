...
interface CatalogApiList {
    ...
    fun createBulkProductUploadJob(@Path("company_id") companyId: String, @Query("department") department: String, @Query("product_type") productType: String,@Body body: BulkJob)
