...
interface OrdersApiList {
    ...
    fun getOrderShipmentDetails(@Path("company_id") companyId: String, @Path("shipment_id") shipmentId: String)
    : Deferred<Response<ShipmentDetailsResponse>>
    
    @GET ("/service/platform/orders/v1.0/company/{company_id}/order-details")
    fun getShipmentDetails(@Path("company_id") companyId: String, @Query("order_id") orderId: String)
    : Deferred<Response<ShipmentDetailsResponse>>
