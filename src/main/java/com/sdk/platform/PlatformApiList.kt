...
interface OrderManageApiList {
    ...
    fun manualStoreReassignment(@Path("company_id") companyId: String,@Body body: ManualStoreReassign)
    : Deferred<Response<SuccessResponse>>
    
    @POST ("/service/platform/order-manage/v1.0/company/{company_id}/shipment/edd-update")
    fun shipmentEDDUpdate(@Path("company_id") companyId: String,@Body body: ShipmentEDDUpdate)
    : Deferred<Response<SuccessResponse>>
