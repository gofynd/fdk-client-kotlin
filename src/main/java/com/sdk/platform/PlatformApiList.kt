...
interface PaymentApiList {
    ...
    fun getPayoutPennyDropAndChequeConfig(@Path("company_id") companyId: String)
...
interface CatalogApiList {
    ...
    fun getAllCollections(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("q") q: String?, @Query("type") type: String?, @Query("tags") tags: ArrayList<String>?, @Query("is_active") isActive: Boolean?, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    ...
    fun getProductAttributes(@Path("company_id") companyId: String, @Query("q") q: String?, @Query("department") department: ArrayList<Any>?, @Query("category") category: String?, @Query("filtered") filtered: Boolean?, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?, @Query("sort") sort: Int?)
...
interface CompanyProfileApiList {
    ...
    fun getCompanyRestrictedCategoryInfo(@Path("company_id") companyId: String)
    ...
    fun getCompanyRestrictedCategoryInfoOfOneType(@Path("company_id") companyId: String)
    ...
    fun createCompanyRestrictedCategoryDocument(@Path("company_id") companyId: String)
    ...
    fun updateCompanyRestrictedCategoryDocument(@Path("company_id") companyId: String, @Path("document_id") documentId: String)
    : Deferred<Response<SuccessResponseSerializer>>
...
interface OrdersApiList {
    ...
    fun getLaneConfig(@Path("company_id") companyId: String, @Query("super_lane") superLane: String?, @Query("from_date") fromDate: String?, @Query("to_date") toDate: String?)
    ...
    fun getShipmentList(@Path("company_id") companyId: String, @Query("lane") lane: String?, @Query("search_type") searchType: String?, @Query("search_id") searchId: String?, @Query("from_date") fromDate: String?, @Query("to_date") toDate: String?)
