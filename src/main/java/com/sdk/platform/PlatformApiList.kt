...
interface UserApiList {
    ...
    fun unArchiveUser(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: UnArchiveUserRequestSchema)
...
interface OrderApiList {
    ...
    fun getOrderDetails1(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("order_id") orderId: String?, @Query("next") next: String?, @Query("previous") previous: String?)
    : Deferred<Response<OrderDetails>>
    ...
    fun createOrder(@Path("company_id") companyId: String,@Body body: CreateOrderPayload)
    ...
    fun updateShipmentStatus(@Path("company_id") companyId: String,@Body body: UpdateShipmentStatusPayload)
    : Deferred<Response<UpdateShipmentStatusResponse1>>
    
    @GET ("/service/platform/orders/v1.0/company/{company_id}/shipment-details")
    fun getShipmentDetailsById(@Path("company_id") companyId: String, @Query("shipment_id") shipmentId: String)
    : Deferred<Response<ShipmentDetailsPlatformResponse>>
    
    @GET ("/service/platform/orders/v1.0/company/{company_id}/shipments")
    fun getShipmentsByShipmentIds(@Path("company_id") companyId: String, @Query("shipment_ids") shipmentIds: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    : Deferred<Response<BulkShipmentDetailsPlatformResponse>>
    
    @GET ("/service/platform/orders/v1.0/company/{company_id}/order-details")
    fun getOrderById(@Path("company_id") companyId: String, @Query("fynd_order_id") fyndOrderId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    ...
    fun getShipmentByAffiliateBagId(@Path("company_id") companyId: String, @Query("affiliate_bag_id") affiliateBagId: String, @Query("affiliate_id") affiliateId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    ...
    fun getShipmentByAffiliateShipmentId(@Path("company_id") companyId: String, @Query("affiliate_shipment_id") affiliateShipmentId: String, @Query("affiliate_id") affiliateId: String)
    : Deferred<Response<ShipmentDetailsPlatformResponse>>
    
    @GET ("/service/platform/orders/v1.0/company/{company_id}/shipment-details-by-affiliate-order-id")
    fun getShipmentsByAffiliateOrderId(@Path("company_id") companyId: String, @Query("affiliate_id") affiliateId: String, @Query("affiliate_order_id") affiliateOrderId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    : Deferred<Response<BulkShipmentDetailsPlatformResponse>>
...
interface CatalogApiList {
    ...
    fun listProductTemplate(@Path("company_id") companyId: String, @Query("department") department: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
...
interface ConfigurationApiList {
    ...
    fun getDomains(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("comapny_id") comapnyId: String, @Path("appication_id") appicationId: String)
