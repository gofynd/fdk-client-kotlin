...
data class InvoiceData(
    ...
    var invoice: InvoiceDetailsData?=null,
    
    @SerializedName("invoice_items")
    var invoiceItems: ArrayList<InvoiceItems>?=null,
    
    @SerializedName("shopsense_details")
    var shopsenseDetails: CompanyInfo?=null
...
data class InvoiceDetailsData(
    ...
    var statusTrail: ArrayList<StatusTrail>?=null,
...
data class Plan(
    ...
    var feeComponents: @RawValue ArrayList<HashMap<String,Any>>?=null,
...
data class Subscription(
    ...
    @SerializedName("is_eligible_for_plan_change")
    var isEligibleForPlanChange: Boolean?=null,
...
*/
@Parcelize
data class AuthorModifiedDetails(
...
data class Author(
    ...
    var modifiedByDetails: AuthorModifiedDetails?=null,
...
data class PaymentData(
    ...
    var uniqueTransactionReference: String?=null
