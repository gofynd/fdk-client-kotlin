...
interface BillingApiList {
    ...
    suspend fun currentLimit(@Path("company_id") companyId: String, @Query("product_suite") productSuite: String?, @Query("type") type: String?, @HeaderMap headers: Map<String, String>? = null)
    : Response<SubscriptionLimit>
