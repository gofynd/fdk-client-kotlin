...
interface BillingApiList {
    ...
    suspend fun creditTransaction(@Path("company_id") companyId: String, @Query("unique_id") uniqueId: Int, @Query("product_suite") productSuite: String, @Query("type") type: String, @Query("page_size") pageSize: Int?, @Query("page_no") pageNo: Int?, @Query("sort") sort: String?, @Query("query") query: HashMap<String,Any>?)
    ...
    suspend fun subscriptionPlanChange(@Path("company_id") companyId: String, @Query("product_suite") productSuite: String?, @Query("unique_id") uniqueId: Int?, @Query("platform") platform: String?, @Query("plan_id") planId: String?)
