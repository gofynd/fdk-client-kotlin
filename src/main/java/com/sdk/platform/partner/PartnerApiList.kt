...
interface PartnerApiList {
    ...
    suspend fun getPrivateExtensions(@Path("company_id") companyId: String, @Query("page_size") pageSize: Double?, @Query("page_no") pageNo: Double?, @Query("query") query: HashMap<String,Any>?)
