...
inner class ApplicationClient(val applicationId:String,val config: PlatformConfig){
    ...
    suspend fun getProductSizeSellers(itemId: String, size: String, pincode: String?=null, strategy: String?=null, pageNo: Int?=null, pageSize: Int?=null)
    : Response<ProductSizeSellersResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                catalogApiList?.getProductSizeSellers(itemId = itemId, companyId = config.companyId , applicationId = applicationId , size = size, pincode = pincode, strategy = strategy, pageNo = pageNo, pageSize = pageSize )
        } else {
            null
        }
    }
    ...
    /**
    *
    * Summary: Paginator for getProductSizeSellers
    **/
    fun getProductSizeSellersPaginator(
    itemId: String, size: String, pincode: String?=null, strategy: String?=null, pageSize: Int?=null
        ...
        paginator.setCallBack(object : PaginatorCallback<ProductSizeSellersResponse> {
            ...
            override suspend fun onNext(
                ...
                if (config.oauthClient.isAccessTokenValid()) {
                    ...
                    val pageType = "number"
                    catalogApiList?.getProductSizeSellers(itemId = itemId, companyId = config.companyId , applicationId = applicationId , size = size, pincode = pincode, strategy = strategy, pageNo = pageNo, pageSize = pageSize)?.safeAwait{ response, error ->
                        response?.let {
