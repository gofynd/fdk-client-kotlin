...
interface ServiceabilityApiList {
    ...
    fun updateApplicationServiceability(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: ServiceabilityPayloadSchema)
    : Deferred<Response<ApplicationServiceabilityConfigResponse>>
    ...
    fun updateSelfShip(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: SelfShipResponse)
    ...
    fun getSelfShip(@Path("company_id") companyId: String, @Path("application_id") applicationId: String)
    : Deferred<Response<ApplicationSelfShipConfigResponse>>
