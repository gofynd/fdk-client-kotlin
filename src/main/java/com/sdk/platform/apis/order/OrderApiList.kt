...
interface OrderApiList {
    ...
    suspend fun getAssetByShipmentIds(@Path("company_id") companyId: String, @Query("shipment_ids") shipmentIds: String, @Query("invoice") invoice: Boolean?, @Query("expires_in") expiresIn: String?)
    : Response<ResponseGetAssetShipment>
    ...
    suspend fun getMetricCount(@Path("company_id") companyId: String, @Query("from_date") fromDate: String?, @Query("to_date") toDate: String?)
    : Response<MetricCountResponse>
    
    @GET ("/service/platform/order/v1.0/company/{company_id}/application/{application_id}/order-details")
    suspend fun getAppOrderShipmentDetails(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("order_id") orderId: String)
    : Response<OrderDetailsResponse>
    ...
    suspend fun createShipmentReport(@Path("company_id") companyId: String, @Query("from_date") fromDate: String?, @Query("to_date") toDate: String?)
    : Response<Success>
    
    @GET ("/service/platform/order/v1.0/company/{company_id}/reports/shipment-listing")
    suspend fun getReportsShipmentListing(@Path("company_id") companyId: String, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    : Response<OmsReports>
    
    @POST ("/service/platform/order/v1.0/company/{company_id}/upsert/jiocode/article")
    suspend fun upsertJioCode(@Path("company_id") companyId: String,@Body body: JioCodeUpsertPayload)
    : Response<JioCodeUpsertResponse>
    ...
    suspend fun processManifest(@Path("company_id") companyId: String,@Body body: ProcessManifest)
    ...
    suspend fun getManifests(@Path("company_id") companyId: String, @Query("status") status: String?, @Query("to_date") toDate: String?, @Query("from_date") fromDate: String?, @Query("search_value") searchValue: String?, @Query("dp_ids") dpIds: String?, @Query("page_no") pageNo: String?, @Query("page_size") pageSize: String?)
    : Response<ManifestList>
    
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/manifest/details")
    suspend fun getManifestDetails(@Path("company_id") companyId: String, @Query("manifest_id") manifestId: String, @Query("status") status: String?, @Query("to_date") toDate: String?, @Query("from_date") fromDate: String?, @Query("search_type") searchType: String?, @Query("search_value") searchValue: String?, @Query("dp_ids") dpIds: String?, @Query("page_no") pageNo: String?, @Query("page_size") pageSize: String?)
