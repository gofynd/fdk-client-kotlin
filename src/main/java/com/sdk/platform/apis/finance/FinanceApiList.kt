...
interface FinanceApiList {
    ...
    : Deferred<Response<GetReportListResponse>>
    ...
    fun isCnRefundMethod(@Path("company_id") companyId: String,@Body body: IsCnRefundMethodRequest)
    : Deferred<Response<IsCnRefundMethodResponse>>
