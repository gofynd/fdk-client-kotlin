...
class CatalogDataManagerClass(val config: PlatformConfig, val unauthorizedAction: ((url: String, responseCode: Int) -> Unit)? = null) : BaseRepository() {        
    ...
    suspend fun getInventories(itemId: Int?=null, size: String?=null, pageNo: Int?=null, pageSize: Int?=null, q: String?=null, sellable: Boolean?=null, storeIds: ArrayList<Int>?=null, sizeIdentifier: Int?=null)
...
inner class ApplicationClient(val applicationId:String,val config: PlatformConfig){
    ...
    **/
    ...
    suspend fun getApplicationBrands(department: String?=null, pageNo: Int?=null, pageSize: Int?=null, q: String?=null, brandId: Int?=null)
    : Response<BrandListingResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
    ...
    **/
    ...
    department: String?=null, pageSize: Int?=null, q: String?=null, brandId: Int?=null
    ...
    **/
    ...
    suspend fun getAppLocations(storeType: String?=null, uid: String?=null, q: String?=null, stage: String?=null, pageNo: Int?=null, pageSize: Int?=null, tags: ArrayList<String>?=null, storeTypes: ArrayList<String>?=null, companyUids: ArrayList<Int>?=null)
    ...
    **/
    ...
    storeType: String?=null, uid: String?=null, q: String?=null, stage: String?=null, pageSize: Int?=null, tags: ArrayList<String>?=null, storeTypes: ArrayList<String>?=null, companyUids: ArrayList<Int>?=null
    ...
    **/
    ...
    suspend fun createMerchandisingRuleBoostAction(merchandisingRuleId: String,body: GetMerchandisingRuleBoostAction)
    : Response<SuccessResponseMerchandising>? {
        return if (config.oauthClient.isAccessTokenValid()) {
    ...
    suspend fun updateMerchandisingRuleBoostAction(merchandisingRuleId: String,body: GetMerchandisingRuleBoostAction)
    : Response<SuccessResponseMerchandising>? {
        return if (config.oauthClient.isAccessTokenValid()) {
    ...
    suspend fun createMerchandisingRuleBuryAction(merchandisingRuleId: String,body: GetMerchandisingRuleBuryAction)
    : Response<SuccessResponseMerchandising>? {
        return if (config.oauthClient.isAccessTokenValid()) {
    ...
    suspend fun updateMerchandisingRuleBuryAction(merchandisingRuleId: String,body: GetMerchandisingRuleBuryAction)
    : Response<SuccessResponseMerchandising>? {
        return if (config.oauthClient.isAccessTokenValid()) {
    ...
    suspend fun createAppPriceFactory(body: CreateAppPriceFactoryRequest)
    ...
    suspend fun editAppPriceFactory(id: String,body: EditAppPriceFactoryRequest)
    : Response<AppPriceFactory>? {
        return if (config.oauthClient.isAccessTokenValid()) {
    ...
    suspend fun addProductsInPriceFactoryByZoneId(id: String, zoneId: String,body: CreateAppPriceFactoryProductRequest)
    : Response<CreateAppPriceFactoryProductsResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                catalogApiList?.addProductsInPriceFactoryByZoneId(companyId = config.companyId , applicationId = applicationId , id = id, zoneId = zoneId, body = body)
        } else {
            null
        }
    }
    ...
    suspend fun getProductsInPriceFactoryByZoneId(id: String, zoneId: String, itemId: Boolean?=null, sellerIdentifier: String?=null, pageNo: Int?=null, pageSize: Int?=null)
    : Response<CreateAppPriceFactoryProductsResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                catalogApiList?.getProductsInPriceFactoryByZoneId(companyId = config.companyId , applicationId = applicationId , id = id, zoneId = zoneId, itemId = itemId, sellerIdentifier = sellerIdentifier, pageNo = pageNo, pageSize = pageSize )
        } else {
            null
        }
    }
    ...
    suspend fun updateProductPriceByZoneInPriceFactory(id: String, itemId: String, zoneId: String,body: UpdateAppPriceFactoryProductRequest)
    : Response<UpdateAppPriceFactoryProductResponse>? {
        return if (config.oauthClient.isAccessTokenValid()) {
                catalogApiList?.updateProductPriceByZoneInPriceFactory(companyId = config.companyId , applicationId = applicationId , id = id, itemId = itemId, zoneId = zoneId, body = body)
        } else {
            null
        }
    }
