...
interface CatalogApiList {
    ...
    suspend fun listProductTemplateCategories(@Path("company_id") companyId: String, @Query("departments") departments: String, @Query("item_type") itemType: String, @Query("page_size") pageSize: Double?, @Query("page_no") pageNo: Double?, @Query("q") q: String?, @Query("slug") slug: String?, @HeaderMap headers: Map<String, String>? = null)
