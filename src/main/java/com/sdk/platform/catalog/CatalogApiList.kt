...
interface CatalogApiList {
    ...
    suspend fun createSearchRerank(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: CreateSearchRerankRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun updateSearchRerankConfiguration(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String,@Body body: UpdateSearchRerankRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun patchProductExportDetail(@Path("company_id") companyId: String, @Path("job_id") jobId: String,@Body body: ExportPatchRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun patchInventoryExportDetail(@Path("company_id") companyId: String, @Path("job_id") jobId: String,@Body body: ExportPatchRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun updateListingConfiguration(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("config_type") configType: String, @Path("config_id") configId: String,@Body body: AppConfigurationsFilterResponseSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<AppConfigurationsFilterResponseSchema>
    ...
    suspend fun updateInventories(@Path("company_id") companyId: String,@Body body: InventoryV2RequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun deleteRealtimeInventory(@Path("company_id") companyId: String, @Path("item_id") itemId: String, @Path("seller_identifier") sellerIdentifier: String,@Body body: InventoryV2RequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<InventoryUpdateResponseSchema>
    
    @POST ("/service/platform/catalog/v2.0/company/{company_id}/products/{item_id}/inventory/{seller_identifier}")
    suspend fun updateRealtimeInventory(@Path("company_id") companyId: String, @Path("item_id") itemId: String, @Path("seller_identifier") sellerIdentifier: String,@Body body: InventoryV2RequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<InventoryUpdateResponseSchema>
    ...
    suspend fun updateMarketplaceOptin(@Path("company_id") companyId: String, @Path("marketplace") marketplace: String,@Body body: UpdateMarketplaceOptinRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun createMarketplaceOptin(@Path("company_id") companyId: String, @Path("marketplace") marketplace: String,@Body body: CreateMarketplaceOptinRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun createMerchandisingRulePinAction(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("merchandising_rule_id") merchandisingRuleId: String,@Body body: PinRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun updateMerchandisingRulePinAction(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("merchandising_rule_id") merchandisingRuleId: String,@Body body: PinRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<SuccessResponseMerchandising>
    ...
    suspend fun createMerchandisingRuleHideAction(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("merchandising_rule_id") merchandisingRuleId: String,@Body body: HideRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<SuccessResponseMerchandising>
    ...
    suspend fun updateMerchandisingRuleHideAction(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("merchandising_rule_id") merchandisingRuleId: String,@Body body: HideRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<SuccessResponseMerchandising>
    ...
    suspend fun addProductsInPriceFactoryByZoneId(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String,@Body body: CreatePriceFactoryProductRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun createProductPriceFactoryBulkJob(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String,@Body body: CreateAppPriceFactoryProductBulkJobRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun validateProductPriceFactoryBulkJob(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String, @Path("job_id") jobId: String,@Body body: CreateAppPriceFactoryProductBulkJobRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun processProductPriceFactoryBulkJob(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String, @Path("job_id") jobId: String,@Body body: CreateAppPriceFactoryProductBulkJobRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<CreateAppPriceFactoryProductBulkJobResponseSchema>
    
    @POST ("/service/platform/catalog/v1.0/company/{company_id}/owner-application/{application_id}/price-factory/{id}/export")
    suspend fun exportProductsInPriceFactory(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String,@Body body: CreateAppPriceFactoryProductExportJobRequestSchema, @HeaderMap headers: Map<String, String>? = null)
