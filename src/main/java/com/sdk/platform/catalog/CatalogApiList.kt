...
interface CatalogApiList {
    ...
    suspend fun getApplicationBrands(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("department") department: String?, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?, @Query("q") q: String?, @Query("brand_id") brandId: Int?)
    : Response<BrandListingResponse>
    ...
    suspend fun getAppLocations(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("store_type") storeType: String?, @Query("uid") uid: String?, @Query("q") q: String?, @Query("stage") stage: String?, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?, @Query("tags") tags: ArrayList<String>?, @Query("store_types") storeTypes: ArrayList<String>?, @Query("company_uids") companyUids: ArrayList<Int>?)
    ...
    suspend fun getInventories(@Path("company_id") companyId: String, @Query("item_id") itemId: Int?, @Query("size") size: String?, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?, @Query("q") q: String?, @Query("sellable") sellable: Boolean?, @Query("store_ids") storeIds: ArrayList<Int>?, @Query("size_identifier") sizeIdentifier: Int?)
    ...
    suspend fun createMerchandisingRuleBoostAction(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("merchandising_rule_id") merchandisingRuleId: String,@Body body: GetMerchandisingRuleBoostAction)
    : Response<SuccessResponseMerchandising>
    ...
    suspend fun updateMerchandisingRuleBoostAction(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("merchandising_rule_id") merchandisingRuleId: String,@Body body: GetMerchandisingRuleBoostAction)
    : Response<SuccessResponseMerchandising>
    ...
    suspend fun createMerchandisingRuleBuryAction(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("merchandising_rule_id") merchandisingRuleId: String,@Body body: GetMerchandisingRuleBuryAction)
    : Response<SuccessResponseMerchandising>
    ...
    suspend fun updateMerchandisingRuleBuryAction(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("merchandising_rule_id") merchandisingRuleId: String,@Body body: GetMerchandisingRuleBuryAction)
    : Response<SuccessResponseMerchandising>
    ...
    suspend fun createAppPriceFactory(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: CreateAppPriceFactoryRequest)
    ...
    suspend fun editAppPriceFactory(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String,@Body body: EditAppPriceFactoryRequest)
    : Response<AppPriceFactory>
    
    @POST ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}/products/zone/{zone_id}")
    suspend fun addProductsInPriceFactoryByZoneId(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String, @Path("zone_id") zoneId: String,@Body body: CreateAppPriceFactoryProductRequest)
    ...
    suspend fun getProductsInPriceFactoryByZoneId(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String, @Path("zone_id") zoneId: String, @Query("item_id") itemId: Boolean?, @Query("seller_identifier") sellerIdentifier: String?, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    : Response<CreateAppPriceFactoryProductsResponse>
    ...
    suspend fun updateProductPriceByZoneInPriceFactory(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String, @Path("item_id") itemId: String, @Path("zone_id") zoneId: String,@Body body: UpdateAppPriceFactoryProductRequest)
