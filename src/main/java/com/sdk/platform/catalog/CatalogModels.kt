...
data class MerchandisingRulesList(
    ...
    var actions: ArrayList<String>?=null,
...
data class HideRequest(
    ...
    @SerializedName("data")
    var data: ArrayList<HideAttributeRequest>?=null
...
data class ValueConfigType(
    ...
    var bucketPoints: @RawValue ArrayList<Any>?=null,
...
data class UpdateHsnCode(
    ...
    @SerializedName("data")
    var data: UpdateHsnCodesObject?=null
...
data class OptinCompanyDetail(
    ...
    var document: OptinDocument?=null,
...
data class CreateProductDownloadsDataResponse(
    ...
    @SerializedName("notification_emails")
    var notificationEmails: @RawValue ArrayList<Any>?=null,
...
*/
@Parcelize
data class CreateAppPriceFactoryRequest(
...
data class AppPriceFactory(
    ...
    @SerializedName("factory_type_ids")
    var factoryTypeIds: ArrayList<Int>?=null,
...
*/
@Parcelize
data class EditAppPriceFactoryRequest(
...
data class CreateAppPriceFactoryProductResponse(
    ...
    @SerializedName("media")
    var media: @RawValue Any?=null,
    
    @SerializedName("sizes")
    var sizes: @RawValue Any?=null,
    
    @SerializedName("company_sizes")
    var companySizes: @RawValue Any?=null
