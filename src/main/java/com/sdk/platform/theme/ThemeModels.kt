...
*/
@Parcelize
data class CreateThemePreviewBody(
    ...
    @SerializedName("user_group_uid")
    var userGroupUid: Int?=null,
    
    @SerializedName("preview_date_time")
    var previewDateTime: String?=null,
...
*/
@Parcelize
data class CreateThemePreviewResponseSchema(
