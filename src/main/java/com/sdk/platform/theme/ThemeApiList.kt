...
interface ThemeApiList {
    ...
    suspend fun createThemePreview(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("theme_id") themeId: String,@Body body: CreateThemePreviewBody, @HeaderMap headers: Map<String, String>? = null)
