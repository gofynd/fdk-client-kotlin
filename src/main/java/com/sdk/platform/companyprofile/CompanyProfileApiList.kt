...
interface CompanyProfileApiList {
    ...
    suspend fun editBrand(@Path("company_id") companyId: String, @Path("brand_id") brandId: String,@Body body: CreateUpdateBrandRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<ProfileSuccessResponseSchema>
    
    @POST ("/service/platform/catalog/v1.0/company/{company_id}/brand")
    suspend fun createBrand(@Path("company_id") companyId: String,@Body body: CreateUpdateBrandRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<ProfileSuccessResponseSchema>
    ...
    suspend fun createLocationBulk(@Path("company_id") companyId: String,@Body body: BulkLocationSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<ProfileSuccessResponseSchema>
