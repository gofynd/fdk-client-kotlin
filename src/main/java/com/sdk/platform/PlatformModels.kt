...
data class EdcAggregatorAndModelListResponse(
    ...
    var edcModels: @RawValue HashMap<String,Any>?=null,
    
    @SerializedName("aggregators")
    var aggregators: @RawValue HashMap<String,Any>?=null
...
data class StatisticsData(
    ...
    var filterOptions: @RawValue HashMap<String,Any>?=null
...
data class EdcDevice(
    ...
    @SerializedName("edc_models_name")
    var edcModelsName: String?=null,
    ...
    @SerializedName("edc_models_id")
    var edcModelsId: Int?=null,
...
data class EdcAddRequest(
    ...
    @SerializedName("edc_model_id")
    var edcModelId: Int?=null,
...
data class ListSizeGuide(
    ...
    @SerializedName("items")
    var items: ArrayList<GetMultiSizeGuide>?=null
