...
data class CategorySchema(
    ...
    @SerializedName("sub_categories")
    var subCategories: CategorySchema?=null,
...
data class StatuesRequest(
    ...
    @SerializedName("shipments")
    var shipments: ShipmentsRequest?=null,
...
*/
@Parcelize
data class StatusUpdateInternalRequest(
    ...
    var statues: ArrayList<StatuesRequest>?=null
...
data class ShipmentsResponse(
    ...
    @SerializedName("shipment_id")
    var shipmentId: ShipmentidResponse?=null
...
data class StatuesResponse(
    ...
    @SerializedName("shipments")
    var shipments: ShipmentsResponse?=null
...
*/
@Parcelize
data class StatusUpdateInternalResponse(
...
data class OrderStatusData(
    ...
    var orderDetails: OrderDetails1?=null
...
/*
    Model: PlatformDeliveryAddress1
*/
@Parcelize
data class PlatformDeliveryAddress1(
...
data class OrderBags(
    ...
    @SerializedName("delivery_address")
    var deliveryAddress: PlatformDeliveryAddress1?=null
...
data class ShipmentDetailsResponse(
    ...
    @SerializedName("shipments")
    var shipments: ArrayList<PlatformShipment1>?=null,
...
/*
    Model: PlatformBreakupValues1
*/
@Parcelize
data class PlatformBreakupValues1(
...
data class PlatformOrderItems(
    ...
    @SerializedName("breakup_values")
    var breakupValues: ArrayList<PlatformBreakupValues1>?=null,
...
data class MetricsCount(
    ...
    @SerializedName("options")
    var options: ArrayList<Options1>?=null,
...
*/
@Parcelize
data class PlatformShipmentTrack1(
