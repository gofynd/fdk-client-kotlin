...
*/
@Parcelize
data class InternalDiscountQuery(
    
    
    
    @SerializedName("job_ids")
    var jobIds: ArrayList<String>?=null,
...
data class DiscountDetail(
    ...
    @SerializedName("discount")
    var discount: ArrayList<DiscountValueObject>?=null,
...
data class DiscountList(
    ...
    @SerializedName("items")
    var items: ArrayList<DiscountDetail>?=null,
