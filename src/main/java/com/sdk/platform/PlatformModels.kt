...
*/
@Parcelize
data class EntityRegionView_Request_schema(
...
*/
@Parcelize
data class EntityRegionView_Response_schema(
...
*/
@Parcelize
data class CompanyStoreView_Response_schema(
...
data class ZoneRequest(
    ...
    @SerializedName("channels")
    var channels: @RawValue ArrayList<HashMap<String,Any>>?=null
...
*/
@Parcelize
data class GetZoneDataViewProduct(
...
data class GetZoneDataViewItems(
    ...
    @SerializedName("channels")
    var channels: GetZoneDataViewChannels?=null,
    
    @SerializedName("pincodes_count")
    var pincodesCount: Int?=null,
    
    @SerializedName("product")
    var product: GetZoneDataViewProduct?=null,
...
data class GetSingleZoneDataViewResponse(
    ...
    @SerializedName("data")
    var data: ArrayList<GetZoneDataViewItems>?=null
