...
/*
    Model: FreshchatRestoreIdRequestSchema
*/
@Parcelize
data class FreshchatRestoreIdRequestSchema(
...
/*
    Model: UserStoreSchema
*/
@Parcelize
data class UserStoreSchema(
...
data class ItemCriteria(
    ...
    @SerializedName("item_id")
    var itemId: ArrayList<String>?=null,
...
data class Restrictions1(
    ...
    @SerializedName("order_quanitity")
    var orderQuanitity: Int?=null,
...
data class PromotionListItem(
    ...
    var applyExclusive: Boolean?=null,
