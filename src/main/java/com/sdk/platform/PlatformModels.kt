...
*/
@Parcelize
data class CreateOneTimeSubscriptionCharge(
...
*/
@Parcelize
data class OneTimeEntitySubscription(
    ...
    @SerializedName("line_items")
    var lineItems: ArrayList<OneTimeCharge>?=null
...
data class CreateOneTimeChargeResponse(
    ...
    var subscription: OneTimeEntitySubscription?=null,
