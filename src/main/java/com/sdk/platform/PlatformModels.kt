...
data class PickupPointSchema(
    ...
    var additionalContacts: @RawValue HashMap<String,Any>?=null,
...
data class TimingObject(
    ...
    var opening: @RawValue HashMap<String,Any>?=null,
    @SerializedName("closing")
    var closing: @RawValue HashMap<String,Any>?=null,
    @SerializedName("open")
...
data class ShippingSchema(
    ...
    var assignment: @RawValue HashMap<String,Any>?=null,
    @SerializedName("_id")
    var id: String?=null,
    @SerializedName("app_id")
    var appId: String?=null
...
data class AssignmentSchema(
    ...
    var fulfillmentPriority: @RawValue HashMap<String,Any>?=null,
...
data class StoreAssignmentObject(
    ...
    var strategy: @RawValue HashMap<String,Any>?=null,
...
data class ZoneSchema(
    ...
    var zoneDetail: @RawValue HashMap<String,Any>?=null,
    @SerializedName("_id")
    var id: String?=null
...
data class ZoneDetailsObject(
    ...
    var radius: @RawValue HashMap<String,Any>?=null,
    @SerializedName("pincode")
    var pincode: @RawValue HashMap<String,Any>?=null,
    @SerializedName("region")
    var region: @RawValue HashMap<String,Any>?=null
...
/*
    Model: ProductTemplateExport
*/
@Parcelize
data class ProductTemplateExport(
    ...
    var templateTags: ArrayList<String>?=null,
    @SerializedName("created_by")
...
data class ProductDownloadsResponse(
    ...
    var page: Page?=null,
    @SerializedName("items")
    var items: ArrayList<ProductTemplateExport>?=null
