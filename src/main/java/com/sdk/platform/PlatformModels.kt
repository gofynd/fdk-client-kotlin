...
*/
@Parcelize
data class ShipmentTrackingResultsResponse(
...
*/
@Parcelize
data class ShipmentTrackingResponse(
    
    
    
    @SerializedName("results")
    var results: ShipmentTrackingResultsResponse?=null,
...
data class Offer(
    ...
    var bannerImage: @RawValue Any?=null,
