...
data class EdcDevice(
    ...
    @SerializedName("edc_serial_no")
    var edcSerialNo: String?=null,
...
*/
@Parcelize
data class EdcDeviceAddUpdateResponse(
...
data class EdcDeviceListResponse(
    ...
    var deviceList: ArrayList<EdcDevice>?=null
...
data class CurrentStatus(
    ...
    var deliveryAwbNumber: Int?=null,
