...
interface ContentApiList {
    ...
    suspend fun createSlideshow(@Path("company_id") companyId: String, @Path("application_id") applicationId: String,@Body body: SlideshowRequest, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun updateSlideshow(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("id") id: String,@Body body: SlideshowRequest, @HeaderMap headers: Map<String, String>? = null)
    : Response<SlideshowSchema>
    ...
    suspend fun getCustomFieldDefinitions(@Path("company_id") companyId: String, @Query("page_no") pageNo: String, @Query("page_size") pageSize: String, @Query("resource") resource: String?, @Query("type") type: String?, @Query("search") search: String?, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun getCustomFieldDefinition(@Path("company_id") companyId: String, @Path("definition_id") definitionId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomFieldDefinitionDetailResSchema>
    
    @PUT ("/service/platform/content/v1.0/company/{company_id}/metafields/definitions/{definition_id}")
    suspend fun updateCustomFieldDefinition(@Path("company_id") companyId: String, @Path("definition_id") definitionId: String,@Body body: CustomFieldDefinitionRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomFieldDefinitionDetailResSchema>
    
    @DELETE ("/service/platform/content/v1.0/company/{company_id}/metafields/definitions/{definition_id}")
    suspend fun deleteCustomFieldDefinition(@Path("company_id") companyId: String, @Path("definition_id") definitionId: String, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun getCustomObjectDefinition(@Path("company_id") companyId: String, @Path("definition_id") definitionId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectDefinitionSchema>
    
    @PUT ("/service/platform/content/v1.0/company/{company_id}/metaobjects/definitions/{definition_id}")
    suspend fun updateCustomObjectDefinition(@Path("company_id") companyId: String, @Path("definition_id") definitionId: String,@Body body: CustomObjectDefinitionUpdateRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectDefinitionSchema>
    
    @DELETE ("/service/platform/content/v1.0/company/{company_id}/metaobjects/definitions/{definition_id}")
    suspend fun deleteCustomObjectDefinition(@Path("company_id") companyId: String, @Path("definition_id") definitionId: String, @HeaderMap headers: Map<String, String>? = null)
    ...
    suspend fun getCustomObject(@Path("company_id") companyId: String, @Path("metaobject_id") metaobjectId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectByIdSchema>
    
    @DELETE ("/service/platform/content/v1.0/company/{company_id}/metaobjects/{metaobject_id}")
    suspend fun deleteCustomObject(@Path("company_id") companyId: String, @Path("metaobject_id") metaobjectId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomDataDeleteSchema>
    
    @PUT ("/service/platform/content/v1.0/company/{company_id}/metaobjects/{metaobject_id}")
    suspend fun updateCustomObject(@Path("company_id") companyId: String, @Path("metaobject_id") metaobjectId: String,@Body body: CustomObjectRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectByIdSchema>
    ...
    suspend fun getAppCustomFieldDefinitions(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Query("page_no") pageNo: String, @Query("page_size") pageSize: String, @Query("resource") resource: String?, @Query("type") type: String?, @Query("search") search: String?, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomFieldDefinitionsSchema>
    ...
    suspend fun getAppCustomFieldDefinition(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("definition_id") definitionId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomFieldDefinitionDetailResSchema>
    
    @PUT ("/service/platform/content/v1.0/company/{company_id}/application/{application_id}/metafields/definitions/{definition_id}")
    suspend fun updateAppCustomFieldDefinition(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("definition_id") definitionId: String,@Body body: CustomFieldDefinitionRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomFieldDefinitionDetailResSchema>
    
    @DELETE ("/service/platform/content/v1.0/company/{company_id}/application/{application_id}/metafields/definitions/{definition_id}")
    suspend fun deleteAppCustomFieldDefinition(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("definition_id") definitionId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomDataDeleteSchema>
    ...
    suspend fun getAppCustomObjectDefinition(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("definition_id") definitionId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectDefinitionSchema>
    
    @PUT ("/service/platform/content/v1.0/company/{company_id}/application/{application_id}/metaobjects/definitions/{definition_id}")
    suspend fun updateAppCustomObjectDefinition(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("definition_id") definitionId: String,@Body body: CustomObjectDefinitionUpdateRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectDefinitionSchema>
    
    @DELETE ("/service/platform/content/v1.0/company/{company_id}/application/{application_id}/metaobjects/definitions/{definition_id}")
    suspend fun deleteAppCustomObjectDefinition(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("definition_id") definitionId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectDefinitionDeleteResponseSchema>
    ...
    suspend fun getAppCustomObject(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("metaobject_id") metaobjectId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectByIdSchema>
    
    @DELETE ("/service/platform/content/v1.0/company/{company_id}/application/{application_id}/metaobjects/{metaobject_id}")
    suspend fun deleteAppCustomObject(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("metaobject_id") metaobjectId: String, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomDataDeleteSchema>
    
    @PUT ("/service/platform/content/v1.0/company/{company_id}/application/{application_id}/metaobjects/{metaobject_id}")
    suspend fun updateAppCustomObject(@Path("company_id") companyId: String, @Path("application_id") applicationId: String, @Path("metaobject_id") metaobjectId: String,@Body body: CustomObjectRequestSchema, @HeaderMap headers: Map<String, String>? = null)
    : Response<CustomObjectByIdSchema>
