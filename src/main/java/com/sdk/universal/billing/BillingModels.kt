...
data class TenureConfigData(
    ...
    @SerializedName("tenure_config")
    var tenureConfig: ArrayList<TenureConfig>?=null
...
*/
@Parcelize
data class TenureConfigResponse(
    ...
    @SerializedName("data")
    var data: TenureConfigData?=null
...
data class PlanTypes(
    ...
    var month: ArrayList<PlanDetails>?=null,
    
    @SerializedName("quarter")
    var quarter: ArrayList<PlanDetails>?=null,
    
    @SerializedName("half_year")
    var halfYear: ArrayList<PlanDetails>?=null,
    
    @SerializedName("year")
    var year: ArrayList<PlanDetails>?=null
...
data class DetailList(
    ...
    var plans: PlanTypes?=null,
    
    @SerializedName("trial_plan")
    var trialPlan: TrialPlanDetails?=null
...
data class PlanConfig(
    ...
    var tiers: @RawValue ArrayList<HashMap<String,Any>>?=null
...
data class PlanList(
    ...
    @SerializedName("plan_group_id")
    var planGroupId: String?=null,
