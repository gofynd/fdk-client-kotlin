...
data class CartProductInfo(
    ...
    var charges: @RawValue ArrayList<HashMap<String,Any>>?=null,
...
*/
@Parcelize
data class BulkPriceResponseObject(
...
*/
@Parcelize
data class RewardPointRequestObject(
...
*/
@Parcelize
data class GetAddressesResponseObject(
...
*/
@Parcelize
data class SelectCartAddressRequestObject(
...
*/
@Parcelize
data class ShipmentResponseObject(
...
data class CartShipments(
    ...
    @SerializedName("shipments")
    var shipments: ArrayList<ShipmentResponseObject>?=null,
...
*/
@Parcelize
data class CartCheckoutDetailRequestObject(
...
*/
@Parcelize
data class CartMetaRequestObject(
...
*/
@Parcelize
data class PromotionPaymentOffersResponseObject(
...
*/
@Parcelize
data class CartCheckoutDetailV2RequestObject(
...
*/
@Parcelize
data class CartConfigDetailResponseObject(
