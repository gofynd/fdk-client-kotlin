...
class CartDataManagerClass(val config: ApplicationConfig, val unauthorizedAction: ((url: String, responseCode: Int) -> Unit)? = null) : BaseRepository() {
    ...
    suspend fun getCart(id: String?=null,i: Boolean?=null,b: Boolean?=null,c: Boolean?=null,assignCardId: Int?=null,areaCode: String?=null,buyNow: Boolean?=null,cartType: String?=null,orderType: String?=null, headers: Map<String, String> = emptyMap()): Response<CartDetailResponse>? {
    ...
    suspend fun addItems(i: Boolean?=null,b: Boolean?=null,areaCode: String?=null,buyNow: Boolean?=null,id: String?=null,cartType: String?=null,orderType: String?=null,body: AddCartRequest, headers: Map<String, String> = emptyMap()): Response<AddCartDetailResponse>? {
    ...
    suspend fun deleteCart(id: String?=null,cartType: String?=null,body: DeleteCartRequest, headers: Map<String, String> = emptyMap()): Response<DeleteCartDetailResponse>? {
    ...
    suspend fun removeCoupon(id: String?=null,buyNow: Boolean?=null,cartType: String?=null, headers: Map<String, String> = emptyMap()): Response<CartDetailResponse>? {
    ...
    suspend fun getBulkDiscountOffers(itemId: Int?=null,articleId: String?=null,uid: Int?=null,slug: String?=null,cartType: String?=null, headers: Map<String, String> = emptyMap()): Response<BulkPriceResponse>? {
    ...
    suspend fun applyRewardPoints(id: String?=null,i: Boolean?=null,b: Boolean?=null,buyNow: Boolean?=null,cartType: String?=null,body: RewardPointRequest, headers: Map<String, String> = emptyMap()): Response<CartDetailResponse>? {
    ...
    suspend fun getAddresses(cartId: String?=null,buyNow: Boolean?=null,mobileNo: String?=null,checkoutMode: String?=null,tags: String?=null,isDefault: Boolean?=null,userId: String?=null, headers: Map<String, String> = emptyMap()): Response<GetAddressesResponse>? {
    ...
    suspend fun selectPaymentMode(id: String?=null,buyNow: Boolean?=null,orderType: String?=null,body: UpdateCartPaymentRequest, headers: Map<String, String> = emptyMap()): Response<CartDetailResponse>? {
    ...
    suspend fun updateCartWithSharedItems(token: String,action: String,cartId: String?=null, headers: Map<String, String> = emptyMap()): Response<SharedCartResponse>? {
    ...
    suspend fun getPromotionOffers(slug: String?=null,pageSize: Int?=null,promotionGroup: String?=null,storeId: Int?=null, headers: Map<String, String> = emptyMap()): Response<PromotionOffersResponse>? {
    ...
    suspend fun getShipments(pickAtStoreUid: Int?=null,orderingStoreId: Int?=null,i: Boolean?=null,p: Boolean?=null,id: String?=null,buyNow: Boolean?=null,addressId: String?=null,areaCode: String?=null,orderType: String?=null, headers: Map<String, String> = emptyMap()): Response<CartShipmentsResponse>? {
    ...
    suspend fun getPaymentPromotionOffers(id: String?=null,uid: Int?=null, headers: Map<String, String> = emptyMap()): Response<PromotionPaymentOffersResponse>? {
    ...
    suspend fun getCartMetaConfigs( headers: Map<String, String> = emptyMap()): Response<CartMetaConfigListResponse>? {
    ...
    suspend fun getCartMetaConfig(cartMetaId: String, headers: Map<String, String> = emptyMap()): Response<CartConfigDetailResponse>? {
    ...
    suspend fun addItemsv2(buyNow: Boolean?=null,id: String?=null,cartType: String?=null,orderType: String?=null,body: AddCartRequest, headers: Map<String, String> = emptyMap()): Response<AddCartDetailResultV2>? {
