...
class CatalogDataManagerClass(val config: ApplicationConfig, val unauthorizedAction: ((url: String, responseCode: Int) -> Unit)? = null) : BaseRepository() {
    ...
    **/
    ...
    fun getProductPriceBySlug(slug: String, size: String, storeId: Int?=null, pincode: String?=null, depth: String?=null): Deferred<Response<ProductSizePriceResponseV2>>? {
        ...
        return catalogApiList?.getProductPriceBySlug(fullUrl      ,  storeId = storeId,    pincode = pincode,    depth = depth)}
