...
class ConfigurationDataManagerClass(val config: ApplicationConfig) : BaseRepository() {
    ...
    fun getBasicDetails(): Deferred<Response<ApplicationDetailResponse>>? {
    ...
    fun getOrderingStores(): Deferred<Response<OrderingStores>>? {
        return configurationApiList?.getOrderingStores( )}
