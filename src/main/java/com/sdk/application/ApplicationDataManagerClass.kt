...
class FeedbackDataManagerClass(val config: ApplicationConfig) : BaseRepository() {
    ...
    **/
    ...
    fun getAttributes(): Deferred<Response<AttributeResponse>>? {
    ...
    **/
    fun getAttributesPaginator() : Paginator<AttributeResponse>{
    ...
    paginator.setCallBack(object : PaginatorCallback<AttributeResponse> {
            override suspend fun onNext(
                ...
                val pageNo = paginator.pageNo
                val pageType = "number"
                feedbackApiList?.getAttributes()?.safeAwait(
                    onSuccess = { response ->
                    val page = response.peekContent()?.page
                    paginator.setPaginator(hasNext=page?.hasNext?:false,pageNo=if (page?.hasNext == true) ((pageNo ?: 0) + 1) else pageNo)
                    onSuccess.invoke(response)
            ...
            override suspend fun onNext(
                ...
                val pageNo = paginator.pageNo
                val pageType = "number"
                feedbackApiList?.getAttributes()?.safeAwait{ response, error ->
                    response?.let {
                        val page = response.peekContent()?.page
                        paginator.setPaginator(hasNext=page?.hasNext?:false,pageNo=if (page?.hasNext == true) ((pageNo ?: 0) + 1) else pageNo)
                        onResponse.invoke(response, null)
    ...
    **/
    ...
    fun getVotes(id: String?=null, refType: String?=null): Deferred<Response<VoteResponse>>? {
    ...
    **/
    fun getVotesPaginator(id: String?=null, refType: String?=null) : Paginator<VoteResponse>{
    ...
    paginator.setCallBack(object : PaginatorCallback<VoteResponse> {
            override suspend fun onNext(
                ...
                val pageNo = paginator.pageNo
                val pageType = "number"
                feedbackApiList?.getVotes(id = id, refType = refType)?.safeAwait(
                    onSuccess = { response ->
                    val page = response.peekContent()?.page
                    paginator.setPaginator(hasNext=page?.hasNext?:false,pageNo=if (page?.hasNext == true) ((pageNo ?: 0) + 1) else pageNo)
                    onSuccess.invoke(response)
            ...
            override suspend fun onNext(
                ...
                val pageNo = paginator.pageNo
                val pageType = "number"
                feedbackApiList?.getVotes(id = id, refType = refType)?.safeAwait{ response, error ->
                    response?.let {
                        val page = response.peekContent()?.page
                        paginator.setPaginator(hasNext=page?.hasNext?:false,pageNo=if (page?.hasNext == true) ((pageNo ?: 0) + 1) else pageNo)
                        onResponse.invoke(response, null)
