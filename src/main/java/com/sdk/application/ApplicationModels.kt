...
*/
@Parcelize
data class ValidatePincodeSchema(
...
*/
@Parcelize
data class ValidatePincodeResponseSchema(
...
data class PincodeApiResponse(
    ...
    @SerializedName("data")
    var data: ArrayList<DataResponse>?=null,
...
data class ArticlesResponse(
    ...
    var manufacturingTimeSeconds: String?=null,
...
data class LocationDetailsResponse(
    ...
    @SerializedName("articles")
    var articles: ArrayList<ArticlesResponse>?=null
...
data class TATViewResponse(
    ...
    @SerializedName("location_details")
    var locationDetails: ArrayList<LocationDetailsResponse>?=null,
