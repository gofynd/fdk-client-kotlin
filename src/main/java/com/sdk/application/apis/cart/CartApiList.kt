...
interface CartApiList {
    ...
    @POST 
    fun addItems(@Url url1: String?    ,      @Query("i") i: Boolean?, @Query("b") b: Boolean?, @Query("area_code") areaCode: String?, @Query("id") id: String?, @Query("buy_now") buyNow: Boolean?, @Body body: AddCartRequest)
