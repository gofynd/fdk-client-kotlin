...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getAppicationProducts(q: q, f: f, c: c, filters: filters, isDependent: isDependent, sortOn: sortOn, pageId: pageId, pageSize: pageSize, pageNo: pageNo, pageType: pageType, itemIds: itemIds).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getDiscountedInventoryBySizeIdentifier(itemId: itemId, sizeIdentifier: sizeIdentifier, pageNo: pageNo, pageSize: pageSize, locationIds: locationIds).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getAppProducts(brandIds: brandIds, categoryIds: categoryIds, departmentIds: departmentIds, tags: tags, itemIds: itemIds, pageNo: pageNo, pageSize: pageSize, q: q).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getAutocompleteConfig(pageNo: pageNo, pageSize: pageSize, q: q, isActive: isActive).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createSearchRerank(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getSearchRerank().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getSearchRerankDetail(id: id).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateSearchRerankConfiguration(id: id, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.deleteSearchRerankConfiguration(id: id).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createSearchConfiguration(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getSearchConfiguration().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateSearchConfiguration(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.deleteSearchConfiguration().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getAllSearchKeyword(pageNo: pageNo, pageSize: pageSize, q: q, isActive: isActive).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.listDepartmentsData(pageNo: pageNo, itemType: itemType, pageSize: pageSize, name: name, search: search, isActive: isActive, uids: uids).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
| uids | ArrayList<Int>? | no | Filter department by uids. |  
...
```kotlin
platformClient.catalog.patchProductExportDetail(jobId: jobId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getProductExportDetail(jobId: jobId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.patchInventoryExportDetail(jobId: jobId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getInventoryExportDetail(jobId: jobId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.exportInventoryConfig(filter: filter).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.downloadInventoryTemplateView(type: type).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.validateProductTemplateSchema(itemType: itemType, bulk: bulk).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getProductBundle(q: q, slug: slug, pageNo: pageNo, pageSize: pageSize).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getProductValidation(type: type, slug: slug).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getProductSize(itemId: itemId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getCompanyVerification(q: q, pageNo: pageNo, pageSize: pageSize).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getProductVerificationDetails(itemId: itemId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getVariantTypes(templateTag: templateTag).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.getSizeGuides(active: active, q: q, brandId: brandId, tag: tag, pageNo: pageNo, pageSize: pageSize).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getListingConfigurations(configType: configType, pageNo: pageNo, pageSize: pageSize, search: search, uids: uids).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
| uids | ArrayList<Int>? | no | Only for categories config type, Get configuration list filtered by `uids`. |  
...
```kotlin
platformClient.catalog.getProductTemplateBySlug(slug: slug).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.catalog.updateMarketplaceOptin(marketplace: marketplace, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createAutocompleteSettings(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getAutocompleteSettings().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateAutocompleteSettings(id: id, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getAutocompletePreview(q: q, categorySuggestion: categorySuggestion, brandSuggestion: brandSuggestion, collectionSuggestion: collectionSuggestion, productSuggestion: productSuggestion, querySuggestion: querySuggestion).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getMerchandisingRulePinAction(merchandisingRuleId: merchandisingRuleId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createMerchandisingRulePinAction(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateMerchandisingRulePinAction(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getMerchandisingRuleHideAction(merchandisingRuleId: merchandisingRuleId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createMerchandisingRuleHideAction(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateMerchandisingRuleHideAction(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getMerchandisingRuleBoostAction(merchandisingRuleId: merchandisingRuleId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createMerchandisingRuleBoostAction(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateMerchandisingRuleBoostAction(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getMerchandisingRuleBuryAction(merchandisingRuleId: merchandisingRuleId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createMerchandisingRuleBuryAction(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateMerchandisingRuleBuryAction(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createMerchandisingRuleQuery(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getMerchandisingQuery(merchandisingRuleId: merchandisingRuleId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateMerchandisingRuleQuery(merchandisingRuleId: merchandisingRuleId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getMerchandisingRules(pageId: pageId, pageSize: pageSize).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getLivePreview(merchandisingRuleId: merchandisingRuleId, searchKeyword: searchKeyword).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createAppPriceFactory(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getAppPriceFactories(isActive: isActive, factoryTypeId: factoryTypeId, code: code, pageNo: pageNo, pageSize: pageSize).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getAppPriceFactory(id: id).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.editAppPriceFactory(id: id, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.addProductsInPriceFactoryByZoneId(id: id, zoneId: zoneId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.getProductsInPriceFactoryByZoneId(id: id, zoneId: zoneId, itemId: itemId, sellerIdentifier: sellerIdentifier, pageNo: pageNo, pageSize: pageSize).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.updateProductPriceByZoneInPriceFactory(id: id, itemId: itemId, zoneId: zoneId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.createProductPriceFactoryBulkJob(id: id, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.pollProductPriceFactoryBulkJob(id: id, jobId: jobId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.validateProductPriceFactoryBulkJob(id: id, jobId: jobId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").catalog.processProductPriceFactoryBulkJob(id: id, jobId: jobId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | bucketPoints | ArrayList<Any>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | customJson | HashMap<String,Any>? |  yes  | Custom JSON data for the item |
 | customMeta | ArrayList<[MetaFields](#MetaFields)>? |  yes  | Custom meta fields for the item |
 | altText | HashMap<String,Any>? |  yes  | Alternative text for the item's images |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | createdBy | HashMap<String,Any>? |  yes  | It is the details of the user who created the category. |
 | createdOn | String? |  yes  | It is Date and time when the category was created. |
 | departments | ArrayList<Int> |  no  | It is the list of unique department the category belongs to. |
 ...
 | modifiedBy | HashMap<String,Any>? |  yes  | It is the details of the user who last modified the category. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | meta | HashMap<String,Any>? |  yes  | Additional metadata for the inventory request. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | customJson | HashMap<String,Any>? |  yes  | Custom JSON data for the article. |
 ...
 | fyndMeta | HashMap<String,Any>? |  yes  | The Fynd metadata of the article. |
 | identifier | HashMap<String,Any> |  no  | The identifier of the article. |
 ...
 | meta | HashMap<String,Any>? |  yes  | Additional metadata for the article. |
 ...
 | rawMeta | HashMap<String,Any>? |  yes  | The raw metadata of the article. |
 ...
 | taxIdentifier | HashMap<String,Any>? |  yes  | The tax identifier of the article. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | sizePromotionThreshold | HashMap<String,Any>? |  yes  |  |
...
---
 ...
 | tpNotes | HashMap<String,Any>? |  yes  | Additional notes for the transfer price. |
...
---
 ...
 | createdBy | [CreatedBy](#CreatedBy)? |  yes  |  |
 | id | String? |  yes  |  |
 | notificationEmails | ArrayList<Any>? |  yes  |  |
 | modifiedOn | String? |  yes  |  |
 | status | String? |  yes  |  |
 | sellerId | Int? |  yes  |  |
 | stats | [Stats](#Stats)? |  yes  |  |
...
---
 ...
 | imageConfig | HashMap<String,Any>? |  yes  | Configuration for the image |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | querySuggestion | HashMap<String,Any>? |  yes  |  |
 | productSuggestion | HashMap<String,Any>? |  yes  |  |
 | collectionSuggestion | HashMap<String,Any>? |  yes  |  |
 | brandSuggestion | HashMap<String,Any>? |  yes  |  |
 | categorySuggestion | HashMap<String,Any>? |  yes  |  |
...
---
 ...
 | departments | ArrayList<Int>? |  yes  |  |
 | factoryType | String? |  yes  |  |
 | factoryTypeIds | ArrayList<Int>? |  yes  |  |
 | code | String? |  yes  |  |
 | name | String? |  yes  |  |
 | isActive | Boolean? |  yes  |  |
 | createdBy | [CreatedBy](#CreatedBy)? |  yes  |  |
