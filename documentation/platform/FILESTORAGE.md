...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.appbrowse(namespace: namespace, page: page, limit: limit, search: search).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.browsefiles(namespace: namespace, page: page, limit: limit, search: search, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.getPdfTypes(countryCode: countryCode, storeOs: storeOs).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.getDefaultPdfData(pdfTypeId: pdfTypeId, countryCode: countryCode).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.updateHtmlTemplate(id: id, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.getDefaultHtmlTemplate(pdfTypeId: pdfTypeId, format: format, countryCode: countryCode).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.saveHtmlTemplate(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.getDefaultPdfTemplate(pdfTypeId: pdfTypeId, format: format, countryCode: countryCode).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").filestorage.generatePaymentReceipt(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
