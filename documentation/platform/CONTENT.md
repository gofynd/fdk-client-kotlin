...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getDefaultSEOMarkupSchema(pageType: pageType).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getSEOMarkupSchemas(title: title, active: active, pageNo: pageNo, pageSize: pageSize).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.createSEOMarkupSchema(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getSEOMarkupSchema(id: id).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.editSEOMarkupSchema(id: id, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.deleteSEOMarkupSchema(id: id).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getCustomFieldTypes().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getResources().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.createCustomFieldDefinition(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getCustomFieldDefinition(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.updateCustomFieldDefinition(definitionId: definitionId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.deleteCustomFieldDefinition(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getCustomFields(resource: resource).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getCustomFieldsByResourceId(resource: resource, resourceId: resourceId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.createCustomFieldByResourceId(resource: resource, resourceId: resourceId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.createCustomObjectDefinition(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getCustomObjectDefinitions(pageNo: pageNo, pageSize: pageSize, search: search).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getCustomObjectDefinition(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.updateCustomObjectDefinition(definitionId: definitionId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.deleteCustomObjectDefinition(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.createCustomObject(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getCustomObject(metaobjectId: metaobjectId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.deleteCustomObject(metaobjectId: metaobjectId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.updateCustomObject(metaobjectId: metaobjectId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.getJobs(page: page, pageSize: pageSize, actionType: actionType).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.importCustomObjectEntries(definitionId: definitionId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.exportCustomObjectEntries(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.content.sampleCustomObjectBulkEntry(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppCustomFieldTypes().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppResources().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.createAppCustomFieldDefinition(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppCustomFieldDefinition(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.updateAppCustomFieldDefinition(definitionId: definitionId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.deleteAppCustomFieldDefinition(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppCustomFields(resource: resource).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppCustomFieldsByResourceId(resource: resource, resourceId: resourceId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.createAppCustomFieldByResourceId(resource: resource, resourceId: resourceId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.createAppCustomObjectDefinition(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppCustomObjectDefinitions(pageNo: pageNo, pageSize: pageSize, search: search).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppCustomObjectDefinition(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.updateAppCustomObjectDefinition(definitionId: definitionId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.deleteAppCustomObjectDefinition(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.createAppCustomObject(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppCustomObject(metaobjectId: metaobjectId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.deleteAppCustomObject(metaobjectId: metaobjectId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.updateAppCustomObject(metaobjectId: metaobjectId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.getAppJobs(page: page, pageSize: pageSize, actionType: actionType).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.importAppCustomObjectEntries(definitionId: definitionId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.exportAppCustomObjectEntries(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").content.sampleAppCustomObjectBulkEntry(definitionId: definitionId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | specifications | ArrayList<[PageSpecItem](#PageSpecItem)>? |  yes  |  |
