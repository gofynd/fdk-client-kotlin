...
```kotlin
platformClient.theme.getCompanyLevelThemes().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
[ArrayList<ThemeSchema>](#ArrayList<ThemeSchema>)
...
```kotlin
platformClient.theme.addMarketplaceThemeToCompany(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.theme.deleteCompanyTheme(themeId: themeId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").theme.getApplicationThemesV2().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
[ArrayList<AllThemesApplicationResponseV2>](#ArrayList<AllThemesApplicationResponseV2>)
...
```kotlin
platformClient.application("<APPLICATION_ID>").theme.getApplicationThemesCountV2().safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").theme.getApplicationThemeByIdV2(themeId: themeId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").theme.updateThemeV2(themeId: themeId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
platformClient.application("<APPLICATION_ID>").theme.applyThemeV2(body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
