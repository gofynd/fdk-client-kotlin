...
```kotlin
catalog.getAppStores(pageNo: pageNo, pageSize: pageSize, q: q, city: city, range: range, latitude: latitude, longitude: longitude).safeAwait{ response,error->
...
---
 ...
 | departments | ArrayList<[Department](#Department)>? |  yes  |  |
