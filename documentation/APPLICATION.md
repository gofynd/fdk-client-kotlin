...
Schema: `{
  "$ref": "#/components/schemas/points.OrderDiscountRes"
}`
...
Schema: `{
  "$ref": "#/components/schemas/points.PointsRes"
}`
...
API handler returns a users points transactions.

```javascript
// Promise
const promise = rewards.getUserPointsHistory(pageID, pageLimit, pageSize, );

// Async/Await
const data = await rewards.getUserPointsHistory(pageID, pageLimit, pageSize, );
...
PointsHistory API handler returns a users points transactions.
...
Schema: `{
  "$ref": "#/components/schemas/points.ReferralInfoRes"
}`
...
Schema: `{
  "$ref": "#/components/schemas/points.RedeemReferralCodeRes"
}`
