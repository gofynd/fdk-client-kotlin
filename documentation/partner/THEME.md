...
```kotlin
partnerClient.theme.getAllPages(themeId: themeId, organizationId: organizationId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.createPage(themeId: themeId, organizationId: organizationId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.updateMultiplePages(themeId: themeId, organizationId: organizationId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.getPage(themeId: themeId, pageValue: pageValue, organizationId: organizationId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.updatePage(themeId: themeId, pageValue: pageValue, organizationId: organizationId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.deletePage(themeId: themeId, pageValue: pageValue, organizationId: organizationId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.getApplicationThemes(organizationId: organizationId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
[ArrayList<ThemesSchema>](#ArrayList<ThemesSchema>)
...
```kotlin
partnerClient.theme.getThemeById(themeId: themeId, organizationId: organizationId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.updateTheme(themeId: themeId, organizationId: organizationId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.deleteTheme(themeId: themeId, organizationId: organizationId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.getOrganizationThemes(organizationId: organizationId, status: status, pageSize: pageSize, pageNo: pageNo).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.getOrganizationThemeDetails(organizationId: organizationId, themeId: themeId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.updateDraftTheme(organizationId: organizationId, themeId: themeId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.submitOrganizationTheme(organizationId: organizationId, themeId: themeId, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.deleteOrganizationTheme(organizationId: organizationId, themeId: themeId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.getLatestVersionOfThemeBySlug(organizationId: organizationId, slugName: slugName).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
[ArrayList<MarketplaceTheme>](#ArrayList<MarketplaceTheme>)
...
```kotlin
partnerClient.theme.createNewThemeInOrganization(organizationId: organizationId, slug: slug, body: body).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.getThemeRejectionReasons(organizationId: organizationId, themeId: themeId).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
...
```kotlin
partnerClient.theme.getThemeVersions(organizationId: organizationId, themeSlug: themeSlug, pageSize: pageSize, pageNo: pageNo).safeAwait{ response, error->
    response?.let{
      // Use response
    } ->
    error?.let{
